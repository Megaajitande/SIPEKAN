...
export default function KodeRegisttp(props) {
    ...
    return (
        ...
        <div className="border-2 border-gray-700 rounded-md">
            ...
            flex justify-center items-center text font-bold text-white">DATA PENITIP/PENGIRIM</div>
                <div className="px-10 grid grid-cols-2 gap-2 items-center justify-center ">
                    ...
                    <div className="flex space-x-1">
                        Nama Penitip/Pengirim : {antrian?.nama_pengirim}
                    </div>
...
KodeRegisttp.layout = (page) => <AuthorizedP children={page} title="Kode Registrasi Tititpan" />
